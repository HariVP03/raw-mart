    ...
    <div className="flex x-10 w-screen h-16 bg-secondary items-center px-5 justify-between text-gray-200">
      ...
      <div className="flex gap-5">
        ...
        <div
          ...
          className="flex cursor-pointer bg-cover bg-center justify-center items-center hover:bg-gray-800 w-10 h-10 rounded-full transition-[background-color] duration-300 text-xl border-2 border-highlight"
        >
